...
namespace encoder {
  ...
  private:
    PIO pio;
    uint sm;
    pimoroni::pin_pair enc_pins;
    uint enc_common_pin;
    pimoroni::Direction enc_direction;
    ...
    //--------------------------------------------------
  public:
    Encoder(PIO pio, uint sm, const pimoroni::pin_pair &pins, uint common_pin = pimoroni::PIN_UNUSED, pimoroni::Direction direction = pimoroni::NORMAL_DIR,
  ...
  public:
    ...
    pimoroni::pin_pair pins() const;
    uint common_pin() const;

    pimoroni::bool_pair state() const;
    int32_t count() const;
    int32_t delta();
    void zero();
    ...
    pimoroni::Direction direction() const;
    void direction(pimoroni::Direction direction);
